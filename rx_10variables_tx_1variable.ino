 ...
 * This code expects a message in the format: 12,25,45,145,255,....,78
...
int values[NUMBER_OF_FIELDS];   // array holding values for all the fields
 ...
 int fb1;  // feedback to transmiter
 byte final = 0;  // value for received all messages
